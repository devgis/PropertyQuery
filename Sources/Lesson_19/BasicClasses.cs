...
namespace MyGIS
{
    ...
    public class GISMyFile
    {
        ...
        static void WriteFeatures(GISVectorLayer layer, BinaryWriter bw)
        {
        ...
        static void WriteFileHeader(GISVectorLayer layer, BinaryWriter bw)
        {
    ...
    public class GISShapefile
    {
        ...
        public static GISVectorLayer ReadShapeFile(string shpfilename)
        {
            ...
            GISVectorLayer layer = new GISVectorLayer(shpfilename, ShapeType, extent, ReadFields(table));
            int rowindex = 0;
